...
int lex() {
    lexLen = 0;
	switch(charClass) {
		case LETTER:	/* charClass before getNonBlank(): LETTER  */	break;
		case DIGIT:		/* charClass before getNonBlank(): DIGIT   */	break;
		case UNKNOWN:	/* charClass before getNonBlank(): UNKNOWN */	break;
	}
    getNonBlank();
	switch(charClass) {
