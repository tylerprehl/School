...
public class House_Catalogue_06 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\nWith public access to data, we've changed data section to be:");
...
//        System.out.println("With public access to verifiers, we've used verifiers to change data section to be: ");
